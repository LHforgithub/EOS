...
namespace EOS.Tools
{
    ...
    public static class ReflectionTools
    {
        ...
        public static readonly BindingFlags AllGetSet = BindingFlags.GetField
            | BindingFlags.SetField
            | BindingFlags.GetProperty
            | BindingFlags.SetProperty;

        /// <summary>检索不包括字段的GetSet方法。</summary>
        public static readonly BindingFlags AllNoGetSet = All & ~AllGetSet;
        ...
        /// </remarks>
        public static Type[] GetSuccessfullyLoadedTypes(Assembly assembly)
        {
            try
            {
		...
		public static List<MethodInfo> GetDeclaredMethods(Type type)
        {
            if (type is null)
            {
                TempLog.Log(new ArgumentNullException(nameof(type)).ToString());
                return new();
            }
        ...
        /// <returns>一个<see cref="MethodInfo"/>集合。如果<paramref name="type"/>为<see langword="null"/>，返回空集合。</returns>
        public static List<MethodInfo> GetNotGetSetMethods(Type type)
        {
            if (type is null)
            {
                TempLog.Log(new ArgumentNullException(nameof(type)).ToString());
        ...
        public static bool IsConstructorOrGeneric(MethodInfo methodInfo)
        {
        ...
        /// </returns>
        public static bool IsParamsAndReturnEquelsWith(MethodInfo methodInfoFirst, MethodInfo methodInfoSecound)
        {
        ...
        /// 
        /// </remarks>
        public static T GetCustomAttribute<T>(MemberInfo memberInfo, bool inherit, bool inheritFromInterfaces) where T : Attribute
        {
            if (!inherit)
            {
        ...
        /// </remarks>
        public static bool IsInheritedBy(MemberInfo original, MemberInfo other)
        {
        ...
        public static bool IsMemberType(MemberInfo memberInfo, MemberTypes memberTypes)
        {
